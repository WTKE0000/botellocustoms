...
const mapSettings = (r) => ({
  ...
  email: r.email, snapchatHandle: r.snapchat_handle, snapchatUrl: r.snapchat_url, heroEyebrow: r.hero_eyebrow,
...
async function updateSettings(fields) {
  ...
  if (fields.snapchatUrl !== undefined) patch.snapchat_url = fields.snapchatUrl;
...
async function updateRaffleSettings(fields) {
  ...
  if (fields.prizeVideo !== undefined) patch.prize_video_url = fields.prizeVideo;
